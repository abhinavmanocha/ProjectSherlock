...
class Chart {
  ...
  createChart1() {
    currentChart = 1;
    double x_offset = cInfo.params.min_x + cInfo.shift_size;
    double y_offset = cInfo.params.min_y + cInfo.shift_size;
    double z_offset = cInfo.params.min_z + cInfo.shift_size;
    ...
    var axes = {
      ...
      'nodes': [
        [
          ..._shiftPlot(
              cInfo.params.min_x, cInfo.params.min_y, cInfo.params.min_z)
        ],
    ...
    var axeslabels = {
      'nodes': [
        [
          ..._shiftPlot(
              cInfo.last_x + 2.0, cInfo.params.min_y, cInfo.params.min_z)
        ],
        [
          ..._shiftPlot(
              cInfo.params.min_x, cInfo.last_y + 2.0, cInfo.params.min_z)
        ],
        [
          ..._shiftPlot(
              cInfo.params.min_x, cInfo.params.min_y, cInfo.last_z + 2.0)
        ],
      ],
      'text': ["x", "y", "z"]
    };
    var xtics = {
      'edgeColour': 0xFF111111,
      'nodes': json.decode(json.encode(cInfo.x_ticks)),
      'edges': json.decode(json.encode(cInfo.x_edges))
    };
    var xtlabels = {
      'nodes': json.decode(json.encode(cInfo.x_lbl_c)),
      'text': [...cInfo.x_lbl]
    };
    var ytics = {
      'edgeColour': 0xFF111111,
      'nodes': json.decode(json.encode(cInfo.y_ticks)),
      'edges': json.decode(json.encode(cInfo.y_edges))
    };
    var ytlabels = {
      'nodes': json.decode(json.encode(cInfo.y_lbl_c)),
      'text': [...cInfo.y_lbl]
    };
    var ztics = {
      'edgeColour': 0xFF111111,
      'nodes': json.decode(json.encode(cInfo.z_ticks)),
      'edges': json.decode(json.encode(cInfo.z_edges))
    };
    var ztlabels = {
      'nodes': json.decode(json.encode(cInfo.z_lbl_c)),
      'text': [...cInfo.z_lbl]
    };
    var stains = {
      'nodeColour': 0xFFBB2222,
      'nodes': json.decode(json.encode(cInfo.stains)),
      'size': 2
    };
    var stainlabels = {
      'nodes': json.decode(json.encode(cInfo.label_coord)),
      'text': [...cInfo.label]
    };
    var endstainlabels = {
      'nodes': json.decode(json.encode(cInfo.end_label_coord)),
      'text': [...cInfo.end_label]
    };
    var strings = {
      'edgeColour': 0xFF22AA22,
      'nodes': json.decode(json.encode(cInfo.strings_nodes)),
      'edges': json.decode(json.encode(cInfo.string_edges))
    };

    var exclstrings = {};
    if (cInfo.Excluded_strings) {
      exclstrings['edgeColour'] = 0xFFFFFF00;
      exclstrings['nodes'] = json.decode(json.encode(cInfo.exclude_strings));
      exclstrings['edges'] = json.decode(json.encode(cInfo.exclude_edges));
    } // if there are excluded strings

    var poi = {
      'nodeColour': 0xFF000000, // ellipse(ball.x, ball.y, ball.r*2, ball.r*2);
      'nodes': json.decode(json.encode(cInfo.poi)),
      'size': 2
    };

    var poierr = {
      'edgeColour': 0xFFEE0000, //  '0xCC0099'    XZ plane plot.
      'nodes': json.decode(json.encode(cInfo.poi_err)),
      'edges': json.decode(json.encode(cInfo.poi_err_e))
    };
    ...
    setRotateCentre(shapes, x_offset, y_offset, z_offset);
    rotateY(1.570796);
    ...
    // graphs[1] = json.decode(json.encode(shapes));
  ...
  createChart2() {
    ...
    var stainlabel3D = {
      // line // for each stain
      'nodes': json.decode(json.encode(cInfo.end_3Dlabel_coord)),
    ...
    var po = {
      ...
      'nodes': json.decode(json.encode(cInfo.po_nodes)),
      'edges': json.decode(json.encode(cInfo.po_edges))
    };

    var exclPo = {};
    if (cInfo.Excluded_strings) {
      exclPo['edgeColour'] = 0xFFFFFF00;
      exclPo['nodes'] = json.decode(json.encode(cInfo.excl_po_nodes));
      exclPo['edges'] = json.decode(json.encode(cInfo.excl_po_edges));
    }

    var poerr = {
      // box around the calculated AO
      'edgeColour': 0xFF550055,
      'nodes': json.decode(json.encode(cInfo.po_err)),
      'edges': json.decode(json.encode(cInfo.po_err_e))
    };
    ...
    var poiline = {
      ...
      'nodes': json.decode(json.encode(cInfo.poi_line)),
      'edges': [
        [0, 1]
      ],
      'size': 2.0
    ...
    var avgpo = {
      ...
      'nodes': json.decode(json.encode(cInfo.avg_po)),
      'size': 2.0
    };
  ...
  void setRotateCentre(var shapes, num x, num y, num z) {
